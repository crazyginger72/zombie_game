...
minetest.register_chatcommand("heal", {
    ...
    if gender.players[plname] == "mz" then
        ...
        gender.changed = true
        gender.players[plname] = "m"
    elseif gender.players[plname] == "fz" then
        player:set_properties({
            visual = "mesh",
            mesh = "characterf.b3d",
            textures = {"characterf.png"},
...
minetest.register_on_joinplayer(function(player)
    ...
    elseif gender.players[plname] == "mz" then
        player:set_properties({
            visual = "mesh",
            mesh = "character.b3d",
    ...
    elseif gender.players[plname] == "fz" then
        ...
        minetest.chat_send_player(plname, "Please set your gender via /gender, thank you. You can also ignore this message and use the default dead model. This message will be shown again when you rejoin.")
